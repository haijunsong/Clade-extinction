...
def main():
    ...
    # 修改为您的实际文件路径
    # excel_path = 'F:/1-投稿/2022-clades灭绝/PBDB Data/SQS results/correlation_results_corrected_SQS_transpose.xlsx'
    excel_path = r'F:\1-投稿\2022-clades灭绝\Pyrate\12 clades 2025-11\output1myr\Correlation_results_corrected_PyRate_transpose.xlsx'
    # 读取 Excel 文件中的数据
    ...
    if meta_analysis_results:
        ...
        results_output_path = os.path.join(os.path.dirname(excel_path), "Meta_Analysis_Results_Pyrate.xlsx")
